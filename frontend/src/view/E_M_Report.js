            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body" >
                                    ...
                                    <div class="row  align-items-center" >
                                        ...
                                        <div class="col-md-2 " >
                                            <button type="submit" class="btn  btn-primary " id="addCustomer" style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: '#000', }} onClick={() => appointmentReportGet()} >Search</button>
                                        </div>
                        ...
                        <div>
                            {head === true ? (
                                <button class="btn  btn-primary" style={{ marginBottom: 25,background:"#FFDA43",border:"#FFDA43",color:"#000" }} onClick={() => downloadPDF()} >Download PDF</button>
                            ) : (
                                <p></p>
                            )}
                        </div>
