                         ...
                         <div class="col-md-12">
                            <div class="card">
                                <div class="card-body" >
                                   ...
                                   <button type="submit" onClick={() => editMyCustomer(id)} class="btn  btn-primary" id="addCustomer" style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: '#fff' }} >Submit</button>
