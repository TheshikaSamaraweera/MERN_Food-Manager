                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body" >
                                    ...
                                    <button type="submit" class="btn  btn-primary" id="addCustomer" style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: '#fff' }}  onClick={() => insertAppointment()}>Submit</button>
                                    <button type="submit" class="btn  btn-primary" id="addCustomer" style={{ backgroundColor: '#ffffff', borderColor: '#FFDA43', color: '#FFDA43', marginLeft: 10, width: 75 }} onClick={() => resetForm()} >Reset</button>
