                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body" >
                                    ...
                                    <button type="submit" class="btn  btn-primary" id="addEmployee" style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: '#000' }} onClick={() => insertEmployee()}>Submit</button>
                                    <button type="submit" class="btn  btn-primary" id="addEmployee" style={{ backgroundColor: '#ffffff', borderColor: '#FFDA43', color: '#000', marginLeft: 10, width:75 }} onClick={() => resetForm()}>Reset</button>
