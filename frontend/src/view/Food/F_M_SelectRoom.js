                            ...
                            <div class="card">
                                <div class="card-body mt-3 mb-2" style={{ margin: "0px" }}>
                                    ...
                                    <div class="row d-flex justify-content-center mb-3">
                                        ...
                                        <button class="btn btn-primary w-75 mx-3 py-2 fw-semibold" onClick={onProceed} style={{ color: '#000', background: '#FFDA43', fontWeight: 'bold', border: '#FFDA43' }}>Proceed</button>
