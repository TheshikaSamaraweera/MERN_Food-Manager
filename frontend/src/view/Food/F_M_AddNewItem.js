                                ...
                                <div class="card-body mt-3 mb-2" style={{ margin: "0px" }}>
                                    ...
                                    <div class="row d-flex justify-content-center mb-2 mt-5">
                                        <div class="col-5 d-flex justify-content-center">
                                            <button style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: 'black' }} class="btn btn-primary w-75 mx-5 py-2 fw-semibold"onClick={() => addItem()}>Add</button>
                                            <button class="btn btn-primary w-75 mx-3 py-2 fw-semibold"
                                                style={{ backgroundColor: '#ffffff', borderColor: '#FFDA43', color: '#000', marginLeft: 10, width:75 }} 
