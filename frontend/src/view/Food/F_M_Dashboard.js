            ...
            <div class="container-fluid">
                ...
                <div class="card" style={{marginRight: "40px"}}>
                    ...
                    <div class="row">
                        ...
                        <div class="row fs-2">
                            <h3 class="mb-2">Hello Theshika!</h3>
                        </div>
                        <div class="row fs-6">
                            <h5 class="mb-0">Food & Beverage Manager</h5>
                        </div>
                        <div class="row">
                            <p class="mb-2">Login Time: {currTime } </p>
                        </div>
                        <div class="row">
                            <a href="/">
                        ...
                        <div class="row m-3 h-75">
                            ...
                            style={{ backgroundColor: "#E8CF6A" }} onClick={onMakeOrder} id="makeOrder">
                                <div class="col-3">
                                <img src={orderFood} class="img-fluid mx-3"></img>
                                </div>
                                <div class="col-6 mx-3 d-flex justify-content-center align-items-center fw-semibold fs-4 px-3 text-black">
                                <p>Make an Order</p>
                                </div>
                            </div>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 ">
                    <div class="card" style={{ width: "350px", backgroundColor: "#9CE3A5" }}>
                    <div class="card-body" style={{ margin: "0px" }}>
                        <div class="row">
                        <div class="col-6 mt-0 px-4 text-white">
                            <h5 class="card-title text-black fs-5">Total Orders</h5>
                            <h1 class="display-5 mt-1 mb-1 text-black fw-bold" style={{ fontSize: "40px" }}>{orderCount}</h1>
                            <h5 class="text-black fs-5">{monthName}</h5>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 ">
                    <div
                    class="card"
                    style={{ width: "350px", backgroundColor: "#F2B66E" ,marginLeft: "60px" }}
                    >
                    <div class="card-body" style={{ margin: "0px" }}>
                        <div class="row">
                        <div class="col-6 mt-0 px-4 text-white">
                            <h5 class="card-title text-black fs-5">Total Revenue</h5>
                            <h1 class="display-5 mt-1 mb-1 text-black fw-bold" style={{ fontSize: "40px" }}>
                            {revenue}K
                            </h1>
                            <h5 class="text-black fs-5">{monthName}</h5>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 ">
                    <div
                    class="card"
                    style={{ width: "350px", backgroundColor: "#F0AEA5" ,marginLeft: "120px"}}
                    >
                    <div class="card-body" style={{ margin: "0px" }}>
                        <div class="row">
                        <div class="col-6 mt-0 px-4 text-black">
                            <h5 class="card-title text-black fs-5">Total Items</h5>
                            <h1 class="display-5 mt-1 mb-1 text-black fw-bold" style={{ fontSize: "40px" }}>
                            {foodCount}
                            </h1>
                            <h5 class="text-black fs-5">{monthName}</h5>
                ...
                <div class="col-md-6 col-lg-4 mx-4 ">
                    ...
                    <div class="card-body" style={{ margin: "0px" }}>
                        ...
                        <div class="row mx-0 d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn text-black fw-semibold" 
                                style={{ backgroundColor: "#FFDA43" }} onClick={onSeeAll}>See All</button>
                            </div>
                        </div>
