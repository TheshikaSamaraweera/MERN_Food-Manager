                                ...
                                <div class="row d-flex justify-content-between mb-4">
                                    ...
                                    <div class="col-6">
                                        <form class="d-flex" role="search">
                                            ...
                                            <button type="button" class="btn btn-primary" onClick={onSearch} style={{background:"#FFDA43",border: '1px solid #FFDA43'}}>
                                    ...
                                    <div class="col-2 mx-4 px-3">
                                        ...
                                        <Popup trigger={
                                            <button type="button" class="btn btn-primary  " style={{background:"#FFDA43",border: '1px solid #FFDA43',marginLeft:-50 , width: '300px' ,height: '100px'}}>
                                                <div class="row">
                                                    <div class="col-7 px-3 d-flex justify-content-end" style={{marginLeft:-50}}>
                                                        <p class="text-black mb-0 fw-bold" style={{fontSize:22}} >{numCartItems} items</p>
                                                    </div>
                                            ...
                                            <div class="container border shadow px-4 py-3 bg-light" style={{width: "360px", position: "absolute", right: "1px", zIndex:1}}>
                                                ...
                                                <div class="row d-flex justify-content-center align-items-center mt-4">
                                                    <div class="col-5 d-flex justify-content-center">
                                                        <button class="btn btn-primary fw-bold" style={{background:"#FFDA43",color: '#000',border: ' #FFDA43'}} onClick={onProceed}>Proceed</button>
                                                    </div>
                                                </div>
