                            ...
                            <div class="card">
                                <div class="card-body mt-3 mb-2" style={{ margin: "0px" }} >
                                    ...
                                    <div class="row  align-items-center px-4 mb-2" >
                                        ...
                                        <div class="col-md-2 " >
                                            <button type="submit" class="btn  btn-primary " id="addCustomer" style={{ backgroundColor: '#FFDA43', borderColor: '#FFDA43', color: '#fff', marginLeft: 50 }} onClick={() => appointmentReportGet()} >Submit</button>
                                        </div>
                                    </div>
